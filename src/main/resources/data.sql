INSERT INTO pokemon (name,type1,type2,total,hp,attack,defense,sp_Atk,sp_Def,speed,generation,legendary)
VALUES
('Bulbasaur','Grass','Poison',318,45,49,49,65,65,45,1,false),
('Ivysaur','Grass','Poison',405,60,62,63,80,80,60,1,false),
('Venusaur','Grass','Poison',525,80,82,83,100,100,80,1,false),
('Venusaur*Mega Venusaur','Grass','Poison',625,80,100,123,122,120,80,1,false),
...
('Charizard*Mega Charizard X','Fire','Dragon',634,78,130,111,130,85,100,1,false),
('Charizard*Mega Charizard Y','Fire','Flying',634,78,104,78,159,115,100,1,false),
...
('Blastoise*Mega Blastoise','Water','',630,79,103,120,135,115,78,1,false),
...
('Beedrill*Mega Beedrill','Bug','Poison',495,65,150,40,15,80,145,1,false),
...
('Pidgeot*Mega Pidgeot','Normal','Flying',579,83,80,80,135,80,121,1,false),
...
('Nidoran*Female','Poison','',275,55,47,52,40,40,41,1,false),
('Nidorina','Poison','',365,70,62,67,55,55,56,1,false),
('Nidoqueen','Poison','Ground',505,90,92,87,75,85,76,1,false),
('Nidoran*Male','Poison','',273,46,57,40,40,40,50,1,false),
...
('Alakazam*Mega Alakazam','Psychic','',590,55,50,65,175,95,150,1,false),
...
('Slowbro*Mega Slowbro','Water','Psychic',590,95,75,180,130,80,30,1,false),
...
('Gengar*Mega Gengar','Ghost','Poison',600,60,65,80,170,95,130,1,false),
...
('Kangaskhan*Mega Kangaskhan','Normal','',590,105,125,100,60,100,100,1,false),
...
('Pinsir*Mega Pinsir','Bug','Flying',600,65,155,120,65,90,105,1,false),
...
('Gyarados*Mega Gyarados','Water','Dark',640,95,155,109,70,130,81,1,false),
...
('Aerodactyl*Mega Aerodactyl','Rock','Flying',615,80,135,85,70,95,150,1,false),
...
('Mewtwo*Mega Mewtwo X','Psychic','Fighting',780,106,190,100,154,100,130,1,true),
('Mewtwo*Mega Mewtwo Y','Psychic','',780,106,150,70,194,120,140,1,true),
...
('Ampharos*Mega Ampharos','Electric','Dragon',610,90,95,105,165,110,45,2,false),
...
('Steelix*Mega Steelix','Steel','Ground',610,75,125,230,55,95,30,2,false),
...
('Scizor*Mega Scizor','Bug','Steel',600,70,150,140,65,100,75,2,false),
('Shuckle','Bug','Rock',505,20,10,230,10,230,5,2,false),
('Heracross','Bug','Fighting',500,80,125,75,40,95,85,2,false),
('Heracross*Mega Heracross','Bug','Fighting',600,80,185,115,40,105,75,2,false),
...
('Houndoom*Mega Houndoom','Dark','Fire',600,75,90,90,140,90,115,2,false),
...
('Tyranitar*Mega Tyranitar','Rock','Dark',700,100,164,150,95,120,71,2,false),
...
('Sceptile*Mega Sceptile','Grass','Dragon',630,70,110,75,145,85,145,3,false),
...
('Blaziken*Mega Blaziken','Fire','Fighting',630,80,160,80,130,80,100,3,false),
...
('Swampert*Mega Swampert','Water','Ground',635,100,150,110,95,110,70,3,false),
...
('Gardevoir*Mega Gardevoir','Psychic','Fairy',618,68,85,65,165,135,100,3,false),
...
('Sableye*Mega Sableye','Dark','Ghost',480,50,85,125,85,115,20,3,false),
('Mawile','Steel','Fairy',380,50,85,85,55,55,50,3,false),
('Mawile*Mega Mawile','Steel','Fairy',480,50,105,125,55,95,50,3,false),
...
('Sharpedo*Mega Sharpedo','Water','Dark',560,70,140,70,110,65,105,3,false),
...
('Camerupt*Mega Camerupt','Fire','Ground',560,70,120,100,145,105,20,3,false),
...
('Altaria*Mega Altaria','Dragon','Fairy',590,75,110,110,110,105,80,3,false),
...
('Banette*Mega Banette','Ghost','',555,64,165,75,93,83,75,3,false),
...
('Absol*Mega Absol','Dark','',565,65,150,60,115,60,115,3,false),
...
('Glalie*Mega Glalie','Ice','',580,80,120,80,120,80,100,3,false),
...
('Salamence*Mega Salamence','Dragon','Flying',700,95,145,130,120,90,120,3,false),
...
('Metagross*Mega Metagross','Steel','Psychic',700,80,145,150,105,110,110,3,false),
...
('Latias*Mega Latias','Dragon','Psychic',700,80,100,120,140,150,110,3,true),
('Latios','Dragon','Psychic',600,80,90,80,130,110,110,3,true),
('Latios*Mega Latios','Dragon','Psychic',700,80,130,100,160,120,110,3,true),
('Kyogre','Water','',670,100,100,90,150,140,90,3,true),
('Kyogre*Primal Kyogre','Water','',770,100,150,90,180,160,90,3,true),
('Groudon','Ground','',670,100,150,140,100,90,90,3,true),
('Groudon*Primal Groudon','Ground','Fire',770,100,180,160,150,90,90,3,true),
('Rayquaza','Dragon','Flying',680,105,150,90,150,90,95,3,true),
('Rayquaza*Mega Rayquaza','Dragon','Flying',780,105,180,100,180,100,115,3,true),
('Jirachi','Steel','Psychic',600,100,100,100,100,100,100,3,true),
('Deoxys*Normal Forme','Psychic','',600,50,150,50,150,50,150,3,true),
('Deoxys*Attack Forme','Psychic','',600,50,180,20,180,20,150,3,true),
('Deoxys*Defense Forme','Psychic','',600,50,70,160,70,160,90,3,true),
('Deoxys*Speed Forme','Psychic','',600,50,95,90,95,90,180,3,true),
...
('Wormadam*Plant Cloak','Bug','Grass',424,60,59,85,79,105,36,4,false),
('Wormadam*Sandy Cloak','Bug','Ground',424,60,79,105,59,85,36,4,false),
('Wormadam*Trash Cloak','Bug','Steel',424,60,69,95,69,95,36,4,false),
...
('Lopunny*Mega Lopunny','Normal','Fighting',580,65,136,94,54,96,135,4,false),
...
('Garchomp*Mega Garchomp','Dragon','Ground',700,108,170,115,120,95,92,4,false),
...
('Lucario*Mega Lucario','Fighting','Steel',625,70,145,88,140,70,112,4,false),
...
('Abomasnow*Mega Abomasnow','Grass','Ice',594,90,132,105,132,105,30,4,false),
...
('Gallade*Mega Gallade','Psychic','Fighting',618,68,165,95,65,115,110,4,false),
...
('Rotom*Heat Rotom','Electric','Fire',520,50,65,107,105,107,86,4,false),
('Rotom*Wash Rotom','Electric','Water',520,50,65,107,105,107,86,4,false),
('Rotom*Frost Rotom','Electric','Ice',520,50,65,107,105,107,86,4,false),
('Rotom*Fan Rotom','Electric','Flying',520,50,65,107,105,107,86,4,false),
('Rotom*Mow Rotom','Electric','Grass',520,50,65,107,105,107,86,4,false),
...
('Giratina*Altered Forme','Ghost','Dragon',680,150,100,120,100,120,90,4,true),
('Giratina*Origin Forme','Ghost','Dragon',680,150,120,100,120,100,90,4,true),
...
('Shaymin*Land Forme','Grass','',600,100,100,100,100,100,100,4,true),
('Shaymin*Sky Forme','Grass','Flying',600,100,103,75,120,75,127,4,true),
...
('Audino*Mega Audino','Normal','Fairy',545,103,60,126,80,126,50,5,false),
...
('Darmanitan*Standard Mode','Fire','',480,105,140,55,30,55,95,5,false),
('Darmanitan*Zen Mode','Fire','Psychic',540,105,30,105,140,105,55,5,false),
...
('Tornadus*Incarnate Forme','Flying','',580,79,115,70,125,80,111,5,true),
('Tornadus*Therian Forme','Flying','',580,79,100,80,110,90,121,5,true),
('Thundurus*Incarnate Forme','Electric','Flying',580,79,115,70,125,80,111,5,true),
('Thundurus*Therian Forme','Electric','Flying',580,79,105,70,145,80,101,5,true),
('Reshiram','Dragon','Fire',680,100,120,100,150,120,90,5,true),
('Zekrom','Dragon','Electric',680,100,150,120,120,100,90,5,true),
('Landorus*Incarnate Forme','Ground','Flying',600,89,125,90,115,80,101,5,true),
('Landorus*Therian Forme','Ground','Flying',600,89,145,90,105,80,91,5,true),
('Kyurem','Dragon','Ice',660,125,130,90,130,90,95,5,true),
('Kyurem*Black Kyurem','Dragon','Ice',700,125,170,100,120,90,95,5,true),
('Kyurem*White Kyurem','Dragon','Ice',700,125,120,90,170,100,95,5,true),
('Keldeo*Ordinary Forme','Water','Fighting',580,91,72,90,129,90,108,5,false),
('Keldeo*Resolute Forme','Water','Fighting',580,91,72,90,129,90,108,5,false),
('Meloetta*Aria Forme','Normal','Psychic',600,100,77,77,128,128,90,5,false),
('Meloetta*Pirouette Forme','Normal','Fighting',600,100,128,90,77,77,128,5,false),
...
('Meowstic*Male','Psychic','',466,74,48,76,83,81,104,6,false),
('Meowstic*Female','Psychic','',466,74,48,76,83,81,104,6,false),
('Honedge','Steel','Ghost',325,45,80,100,35,37,28,6,false),
('Doublade','Steel','Ghost',448,59,110,150,45,49,35,6,false),
('Aegislash*Blade Forme','Steel','Ghost',520,60,150,50,150,50,60,6,false),
('Aegislash*Shield Forme','Steel','Ghost',520,60,50,150,50,150,60,6,false),
...
('Pumpkaboo*Average Size','Ghost','Grass',335,49,66,70,44,55,51,6,false),
('Pumpkaboo*Small Size','Ghost','Grass',335,44,66,70,44,55,56,6,false),
('Pumpkaboo*Large Size','Ghost','Grass',335,54,66,70,44,55,46,6,false),
('Pumpkaboo*Super Size','Ghost','Grass',335,59,66,70,44,55,41,6,false),
('Gourgeist*Average Size','Ghost','Grass',494,65,90,122,58,75,84,6,false),
('Gourgeist*Small Size','Ghost','Grass',494,55,85,122,58,75,99,6,false),
('Gourgeist*Large Size','Ghost','Grass',494,75,95,122,58,75,69,6,false),
('Gourgeist*Super Size','Ghost','Grass',494,85,100,122,58,75,54,6,false),
...
('Zygarde*50% Forme','Dragon','Ground',600,108,100,121,81,95,95,6,true),
('Zygarde*10% Forme','Dragon','Ground',486,54,100,71,61,85,115,6,true),
('Zygarde*Complete Forme','Dragon','Ground',708,216,100,121,91,95,85,6,true),
('Diancie','Rock','Fairy',600,50,100,150,100,150,50,6,true),
('Diancie*Mega Diancie','Rock','Fairy',700,50,160,110,160,110,110,6,true),
('Hoopa*Hoopa Confined','Psychic','Ghost',600,80,110,60,150,130,70,6,true),
('Hoopa*Hoopa Unbound','Psychic','Dark',680,80,160,60,170,130,80,6,true),
('Volcanion','Fire','Water',600,80,110,120,130,90,70,6,true),
('Rowlet','Grass','Flying',320,68,55,55,50,50,42,7,false),
('Dartrix','Grass','Flying',420,78,75,75,70,70,52,7,false),
('Decidueye','Grass','Ghost',530,78,107,75,100,100,70,7,false),
('Litten','Fire','',320,45,65,40,60,40,70,7,false),
('Torracat','Fire','',420,65,85,50,80,50,90,7,false),
('Incineroar','Fire','Dark',530,95,115,90,80,90,60,7,false),
('Popplio','Water','',320,50,54,54,66,56,40,7,false),
('Brionne','Water','',420,60,69,69,91,81,50,7,false),
('Primarina','Water','Fairy',530,80,74,74,126,116,60,7,false),
('Pikipek','Normal','Flying',265,35,75,30,30,30,65,7,false),
('Trumbeak','Normal','Flying',355,55,85,50,40,50,75,7,false),
('Toucannon','Normal','Flying',485,80,120,75,75,75,60,7,false),
('Yungoos','Normal','',253,48,70,30,30,30,45,7,false),
('Gumshoos','Normal','',418,88,110,60,55,60,45,7,false),
('Grubbin','Bug','',300,47,62,45,55,45,46,7,false),
('Charjabug','Bug','Electric',400,57,82,95,55,75,36,7,false),
('Vikavolt','Bug','Electric',500,77,70,90,145,75,43,7,false),
('Crabrawler','Fighting','',338,47,82,57,42,47,63,7,false),
('Crabominable','Fighting','ICE',478,97,132,77,62,67,43,7,false),
('Oricorio*Baile Style','Fire','Flying',476,75,70,70,98,70,93,7,false),
('Oricorio*Pom-Pom Style','Electric','Flying',476,75,70,70,98,70,93,7,false),
('Oricorio*Pa''u Style','Psychic','Flying',476,75,70,70,98,70,93,7,false),
('Oricorio*Sensu Style','Ghost','Flying',476,75,70,70,98,70,93,7,false),
('Cutiefly','Bug','Fairy',304,40,45,40,55,40,84,7,false),
('Ribombee','Bug','Fairy',464,60,55,60,95,70,124,7,false),
('Rockruff','Rock','',280,45,65,40,30,40,60,7,false),
('Rockruff*Own Tempo Rockruff','Rock','',280,45,65,40,30,40,60,7,false),
('Lycanroc*Midday Form','Rock','',487,75,115,65,55,65,112,7,false),
('Lycanroc*Dusk Form','Rock','',487,75,117,65,55,65,110,7,false),
('Wishiwashi*Solo Form','Water','',175,45,20,20,25,25,40,7,false),
('Wishiwashi*School Form','Water','',620,45,140,130,140,135,30,7,false),
('Mareanie','Poison','Water',305,50,53,62,43,52,45,7,false),
('Toxapex','Poison','Water',495,50,63,152,53,142,35,7,false),
('Mudbray','Ground','',385,70,100,70,45,55,45,7,false),
('Mudsdale','Ground','',500,100,125,100,55,85,35,7,false),
('Dewpider','Water','Bug',269,38,40,52,40,72,27,7,false),
('Araquanid','Water','Bug',454,68,70,92,50,132,42,7,false),
('Fomantis','Grass','',250,40,55,35,50,35,35,7,false),
('Lurantis','Grass','',480,70,105,90,80,90,45,7,false),
('Morelull','Grass','Fairy',285,40,35,55,65,75,15,7,false),
('Shiinotic','Grass','Fairy',405,60,45,80,90,100,30,7,false),
('Salandit','Poison','Fire',320,48,44,40,71,40,77,7,false),
('Salazzle','Poison','Fire',480,68,64,60,111,60,117,7,false),
('Stufful','Normal','Fighting',340,70,75,50,45,50,50,7,false),
('Bewear','Normal','Fighting',500,120,125,80,55,60,60,7,false),
('Bounsweet','Grass','',210,42,30,38,30,38,32,7,false),
('Steenee','Grass','',290,52,40,48,40,48,62,7,false),
('Tsareena','Grass','',510,72,120,98,50,98,72,7,false),
('Comfey','Fairy','',485,51,52,90,82,110,100,7,false),
('Oranguru','Normal','Psychic',490,90,60,80,90,110,60,7,false),
('Passimian','Fighting','',490,100,120,90,40,60,80,7,false),
('Wimpod','Bug','Water',230,25,35,40,20,30,80,7,false),
('Golisopod','Bug','Water',530,75,125,140,60,90,40,7,false),
('Sandygast','Ghost','Ground',320,55,55,80,70,45,15,7,false),
('Palossand','Ghost','Ground',480,85,75,110,100,75,35,7,false),
('Pyukumuku','Water','',410,55,60,130,30,130,5,7,false),
('Type: Null','Normal','',534,95,95,95,95,95,59,7,true),
('Silvally','Normal','',570,95,95,95,95,95,95,7,true),
('Minior*Meteor Form','Rock','Flying',440,60,60,100,60,100,60,7,false),
('Minior*Core Form','Rock','Flying',500,60,100,60,100,60,120,7,false),
('Komala','Normal','',480,65,115,65,75,95,65,7,false),
('Turtonator','Fire','Dragon',485,60,78,135,91,85,36,7,false),
('Togedemaru','Electric','Steel',435,65,98,63,40,73,96,7,false),
('Mimikyu','Ghost','Fairy',476,55,90,80,50,105,96,7,false),
('Bruxish','Water','Psychic',475,68,105,70,70,70,92,7,false),
('Drampa','Normal','Dragon',485,78,60,85,135,91,36,7,false),
('Dhelmise','Ghost','Grass',517,70,131,100,86,90,40,7,false),
('Jangmo-o','Dragon','',300,45,55,65,45,45,45,7,false),
('Hakamo-o','Dragon','Fighting',420,55,75,90,65,70,65,7,false),
('Kommo-o','Dragon','Fighting',600,75,110,125,100,105,85,7,false),
('Tapu Koko','Electric','Fairy',570,70,115,85,95,75,130,7,true),
('Tapu Lele','Psychic','Fairy',570,70,85,75,130,115,95,7,true),
('Tapu Bulu','Grass','Fairy',570,70,130,115,85,95,75,7,true),
('Tapu Fini','Water','Fairy',570,70,75,115,95,130,85,7,true),
('Cosmog','Psychic','',200,43,29,31,29,31,37,7,true),
('Cosmoem','Psychic','',400,43,29,131,29,131,37,7,true),
('Solgaleo','Psychic','Steel',680,137,137,107,113,89,97,7,true),
('Lunala','Psychic','Ghost',680,137,113,89,137,107,97,7,true),
('Nihilego','Rock','Poison',570,109,53,47,127,131,103,7,false),
('Buzzwole','Bug','Fighting',570,107,139,139,53,53,79,7,false),
('Pheromosa','Bug','Fighting',570,71,137,37,137,37,151,7,false),
('Xurkitree','Electric','',570,83,89,71,173,71,83,7,false),
('Celesteela','Steel','Flying',570,97,101,103,107,101,61,7,false),
('Kartana','Grass','Steel',570,59,181,131,59,31,109,7,false),
('Guzzlord','Dark','Dragon',570,223,101,53,97,53,43,7,false),
('Necrozma','Psychic','',600,97,107,101,127,89,79,7,true),
('Necrozma*Dusk Mane Necrozma','Psychic','Steel',680,97,157,127,113,109,77,7,true),
('Necrozma*Dawn Wings Necrozma','Psychic','Ghost',680,97,113,109,157,127,77,7,true),
('Necrozma*Ultra Necrozma','Psychic','Dragon',754,97,167,97,167,97,129,7,true),
('Magearna','Steel','Fairy',600,80,95,115,130,115,65,7,false),
('Marshadow','Fighting','Ghost',600,90,125,80,90,90,125,7,false),
('Poipole','Poison','',420,67,73,67,73,67,73,7,false),
('Naganadel','Poison','Dragon',540,73,73,73,127,73,121,7,false),
('Stakataka','Rock','Steel',570,61,131,211,53,101,13,7,false),
('Blacephalon','Fire','Ghost',570,53,127,53,151,79,107,7,false),
('Zeraora','Electric','',600,88,112,75,102,80,143,7,false),
('Meltan','Steel','',300,46,65,65,55,35,34,7,false),
('Melmetal','Steel','',600,135,143,143,80,65,34,7,false),
('Grookey','Grass','',310,50,65,50,40,40,65,8,false),
('Thwackey','Grass','',420,70,85,70,55,60,80,8,false),
('Rillaboom','Grass','',530,100,125,90,60,70,85,8,false),
('Scorbunny','Fire','',310,50,71,40,40,40,69,8,false),
('Raboot','Fire','',420,65,86,60,55,60,94,8,false),
('Cinderace','Fire','',530,80,116,75,65,75,119,8,false),
('Sobble','Water','',310,50,40,40,70,40,70,8,false),
('Drizzile','Water','',420,65,60,55,95,55,90,8,false),
('Inteleon','Water','',530,70,85,65,125,65,120,8,false),
('Skwovet','Normal','',275,70,55,55,35,35,25,8,false),
('Greedent','Normal','',460,120,95,95,55,75,20,8,false),
('Rookidee','Flying','',245,38,47,35,33,35,57,8,false),
('Corvisquire','Flying','',365,68,67,55,43,55,77,8,false),
('Corviknight','Flying','Steel',495,98,87,105,53,85,67,8,false),
('Blipbug','Bug','',180,25,20,20,25,45,45,8,false),
('Dottler','Bug','Psychic',335,50,35,80,50,90,30,8,false),
('Orbeetle','Bug','Psychic',505,60,45,110,80,120,90,8,false),
('Nickit','Dark','',245,40,28,28,47,52,50,8,false),
('Thievul','Dark','',455,70,58,58,87,92,90,8,false),
('Gossifleur','Grass','',250,40,40,60,40,60,10,8,false),
('Eldegoss','Grass','',460,60,50,90,80,120,60,8,false),
('Wooloo','Normal','',270,42,40,55,40,45,48,8,false),
('Dubwool','Normal','',490,72,80,100,60,90,88,8,false),
('Chewtle','Water','',284,50,64,50,38,38,44,8,false),
('Drednaw','Water','Rock',485,90,115,90,48,68,74,8,false),
('Yamper','Electric','',270,59,45,50,40,50,26,8,false),
('Boltund','Electric','',490,69,90,60,90,60,121,8,false),
('Rolycoly','Rock','',240,30,40,50,40,50,30,8,false),
('Carkol','Rock','Fire',410,80,60,90,60,70,50,8,false),
('Coalossal','Rock','Fire',510,110,80,120,80,90,30,8,false),
('Applin','Grass','Dragon',260,40,40,80,40,40,20,8,false),
('Flapple','Grass','Dragon',485,70,110,80,95,60,70,8,false),
('Appletun','Grass','Dragon',485,110,85,80,100,80,30,8,false),
('Silicobra','Ground','',315,52,57,75,35,50,46,8,false),
('Sandaconda','Ground','',510,72,107,125,65,70,71,8,false),
('Cramorant','Flying','Water',475,70,85,55,85,95,85,8,false),
('Arrokuda','Water','',280,41,63,40,40,30,66,8,false),
('Barraskewda','Water','',490,61,123,60,60,50,136,8,false),
('Toxel','Electric','Poison',242,40,38,35,54,35,40,8,false),
('Toxtricity*Low Key Form','Electric','Poison',502,75,98,70,114,70,75,8,false),
('Toxtricity*Amped Form','Electric','Poison',502,75,98,70,114,70,75,8,false),
('Sizzlipede','Fire','Bug',305,50,65,45,50,50,45,8,false),
('Centiskorch','Fire','Bug',525,100,115,65,90,90,65,8,false),
('Clobbopus','Fighting','',310,50,68,60,50,50,32,8,false),
('Grapploct','Fighting','',480,80,118,90,70,80,42,8,false),
('Sinistea','Ghost','',308,40,45,45,74,54,50,8,false),
('Polteageist','Ghost','',508,60,65,65,134,114,70,8,false),
('Hatenna','Psychic','',265,42,30,45,56,53,39,8,false),
('Hattrem','Psychic','',370,57,40,65,86,73,49,8,false),
('Hatterene','Psychic','Fairy',510,57,90,95,136,103,29,8,false),
('Impidimp','Dark','Fairy',265,45,45,30,55,40,50,8,false),
('Morgrem','Dark','Fairy',370,65,60,45,75,55,70,8,false),
('Grimmsnarl','Dark','Fairy',510,95,120,65,95,75,60,8,false),
('Obstagoon','Dark','Normal',520,93,90,101,60,81,95,8,false),
('Perrserker','Steel','',440,70,110,100,50,60,50,8,false),
('Cursola','Ghost','',510,60,95,50,145,130,30,8,false),
('Sirfetch''d','Fighting','',507,62,135,95,68,82,65,8,false),
('Mr. Rime','Psychic','Ice',520,80,85,75,110,100,70,8,false),
('Runerigus','Ground','Ghost',483,58,95,145,50,105,30,8,false),
('Milcery','Fairy','',270,45,40,40,50,61,34,8,false),
('Alcremie','Fairy','',495,65,60,75,110,121,64,8,false),
('Falinks','Fighting','',470,65,100,100,70,60,75,8,false),
('Pincurchin','Electric','',435,48,101,95,91,85,15,8,false),
('Snom','Ice','Bug',185,30,25,35,45,30,20,8,false),
('Frosmoth','Ice','Bug',475,70,65,60,125,90,65,8,false),
('Stonjourner','Rock','',470,100,125,135,20,20,70,8,false),
('Eiscue*Ice Face','Ice','',470,75,80,110,65,90,50,8,false),
('Eiscue*Noice Face','Ice','',470,75,80,70,65,50,130,8,false),
('Indeedee*Male','Psychic','Normal',475,60,65,55,105,95,95,8,false),
('Indeedee*Female','Psychic','Normal',475,70,55,65,95,105,85,8,false),
('Morpeko*Full Belly Mode','Electric','Dark',436,58,95,58,70,58,97,8,false),
('Morpeko*Hangry Mode','Electric','Dark',436,58,95,58,70,58,97,8,false),
('Cufant','Steel','',330,72,80,49,40,49,40,8,false),
('Copperajah','Steel','',500,122,130,69,80,69,30,8,false),
('Dracozolt','Electric','Dragon',505,90,100,90,80,70,75,8,false),
('Arctozolt','Electric','Ice',505,90,100,90,90,80,55,8,false),
('Dracovish','Water','Dragon',505,90,90,100,70,80,75,8,false),
('Arctovish','Water','Ice',505,90,90,100,80,90,55,8,false),
('Duraludon','Steel','Dragon',535,70,95,115,120,50,85,8,false),
('Dreepy','Dragon','Ghost',270,28,60,30,40,30,82,8,false),
('Drakloak','Dragon','Ghost',410,68,80,50,60,50,102,8,false),
('Dragapult','Dragon','Ghost',600,88,120,75,100,75,142,8,false),
('Zacian*Crowned Sword','Fairy','Steel',720,92,170,115,80,115,148,8,true),
('Zacian*Hero of Many Battles','Fairy','',670,92,130,115,80,115,138,8,true),
('Zamazenta*Crowned Shield','Fighting','Steel',720,92,130,145,80,145,128,8,true),
('Zamazenta*Hero of Many Battles','Fighting','',670,92,130,115,80,115,138,8,false),
('Eternatus','Poison','Dragon',690,140,85,95,145,95,130,8,true),
('Eternatus*Eternamax','Poison','Dragon',1125,255,115,250,125,250,130,8,true),
('Kubfu','Fighting','',385,60,90,60,53,50,72,8,true),
('Urshifu*Single Strike Style','Fighting','Dark',550,100,130,100,63,60,97,8,true),
('Urshifu*Rapid Strike Style','Fighting','Water',550,100,130,100,63,60,97,8,true),
('Zarude','Dark','Grass',600,105,120,105,70,95,105,8,false);
